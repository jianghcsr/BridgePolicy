...
expert_data_path = os.environ.get("BRIDGE_POLICY_EXPERT_DATA_PATH", "__BRIDGE_POLICY_EXPERT_DATA_PATH__")
save_data_path = os.environ.get("BRIDGE_POLICY_SAVE_DATA_PATH", "__BRIDGE_POLICY_SAVE_DATA_PATH__")
